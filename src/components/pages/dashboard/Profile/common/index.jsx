    ...
    render: function() {
            if (!this.state.isDeleted) {
                ...
                return (
                    <Jumbotron>
                        {(this.props.isRepost) ?
                            <h5><Link to="/dashboard/feed">{this.props.user.name}</Link> reposted the news from <Link to="/dashboard/feed">{this.props.owner.name}</Link></h5>
                            :
                            <h5><Link to="/dashboard/feed">{this.props.user.name}</Link> posted the news</h5>
                        }
