  ...
  childRoutes: [ 
    {
      ...
      childRoutes: [
        ...
        require('./components/pages/dashboard/Feed'),
        require('./components/pages/dashboard/Create'),
        require('./components/pages/dashboard/Following'),
        require('./components/pages/dashboard/Profile'),
        require('./components/pages/dashboard/Search')
